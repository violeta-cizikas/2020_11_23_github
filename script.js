...
// function getAllUsers() { //jei get, tai nereikia nurodyti antro angumento fetch f-joje
//   fetch('http://167.99.138.67:3300/getallusers')
//     .then(result => result.json())
//     .then(data => {
//       console.log(data)
//       usersArray = data //grazinti duomenys uzsisaugo i usersArray
//       showUsers() //f-jos iskvietimas
//     })
// }

//   function showUsers() {
//       container.innerHTML = "" //istrina turini ir padaro tusciu elementu
//       usersArray.map(item => { //pridedami nauji elementai (keiciamas turinys)
//           container.innerHTML += `
...
//                   <button onclick="showUpdateUser(event)">Edit</button>
...
//     selectedUserId = event.composedPath()[1].id //event masyvo
//       showModal()
//       let selected = usersArray.filter(user => user._id === selectedUserId)

//         nameInput.value = selected[0].name //.value, tik ant inputu galima keisti irasyta info
//         numberInput.value = selected[0].number
//         emailInput.value = selected[0].email
//         ageInput.value = selected[0].age
//         photoInput.value = selected[0].photo
//   }
...
//     method: "POST",
//     headers: {
//       'Content-Type': 'application/json' //turinio tipas
//     },
//     body: JSON.stringify(user)
//   })
//     .then(result => result.json())

//     //fetch'as visalaaik grazina promis'a
//     //.then yra f-ja
//     //res - 1-masis f-jos argumentas (uzvadinamas kaip nori)
//     //http uzklausa rezultata visada grazina kaip stringa
//     //res.json - grazina duomenis json formatu
...
//     // })
//     //resultJson - duomenys(data)
//     .then(() => getAllUsers()) //pasimato naujas sukurtas user'is
// }
...
//     fetch('http://167.99.138.67:3300/updateuser', options)
//     //options - eina kaip antras argumentas, kuris yra sukurtasis kintamasis (let)
//         .then(res => res.json())
//         .then(data => {
//             console.log(data)
//             getAllUsers()
...
//   fetch(`http://167.99.138.67:3300/delete/${id}`)
...
//   function hideModal() {
//     modal[0].style.display = 'none' //pasislepia
//   }

//   function saveModal() {
//     updateUser() //jei nori iskviesti kita f-ja
//     modal[0].style.display = 'none' //pasislepia
//   }
